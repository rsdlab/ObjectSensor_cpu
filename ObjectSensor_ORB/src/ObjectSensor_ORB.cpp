...
static const char* objectsensor_orb_spec[] =
  {
    "implementation_id", "ObjectSensor_ORB",
    "type_name",         "ObjectSensor_ORB",
    ...
    "conf.default.ORB_nfeatures", "2000",
    "conf.default.ORB_scaleFactor", "1.2f",
    "conf.default.ORB_nlevels", "8",
    "conf.default.ORB_edgeThreshold", "31",
    "conf.default.ORB_firstLevel", "0",
    // Widget
    "conf.__widget__.CfgName", "text",
    "conf.__widget__.Display", "text",
    "conf.__widget__.ObjName", "text",
    "conf.__widget__.ORB_nfeatures", "text",
    "conf.__widget__.ORB_scaleFactor", "text",
    "conf.__widget__.ORB_nlevels", "text",
    "conf.__widget__.ORB_edgeThreshold", "text",
    "conf.__widget__.ORB_firstLevel", "text",
    // Constraints
    ""
  };
// </rtc-template>
 ...
 */
ObjectSensor_ORB::ObjectSensor_ORB(RTC::Manager* manager)
 ...
 * @brief destructor
 */
ObjectSensor_ORB::~ObjectSensor_ORB()
{
	// ここから
...
RTC::ReturnCode_t ObjectSensor_ORB::onInitialize()
{
  // Registration: InPort/OutPort/Service
  // <rtc-template block="registration">
  // Set InPort buffers
  ...
  // Set service provider to Ports
  m_ModelPort.registerProvider("AcceptModelService", "AcceptModelService", m_AcceptModelService);
  ...
  bindParameter("ORB_nfeatures", m_ORB_nfeatures, "2000");
  bindParameter("ORB_scaleFactor", m_ORB_scaleFactor, "1.2f");
  bindParameter("ORB_nlevels", m_ORB_nlevels, "8");
  bindParameter("ORB_edgeThreshold", m_ORB_edgeThreshold, "31");
  bindParameter("ORB_firstLevel", m_ORB_firstLevel, "0");
  // </rtc-template>
  //ここから

  _sift.verbose = true;

  m_AcceptModelService.addEventListener(this);

  std::cout << "### Object Sensor Component ###" << std::endl;

  std::cout << "setting initial ORB parameter" << std::endl;
  // set parameter
  _sift.use_gpu = true;
  ...
  m_AcceptModelService.addEventListener(this);
  m_AcceptModelService.lockSetModel();
...
RTC::ReturnCode_t ObjectSensor_ORB::onFinalize()
{
  return RTC::RTC_OK;
}

/*
RTC::ReturnCode_t ObjectSensor_ORB::onStartup(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ObjectSensor_ORB::onShutdown(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
RTC::ReturnCode_t ObjectSensor_ORB::onActivated(RTC::UniqueId ec_id)
{
	//ここから
	...
	extractor = cv::ORB::create(m_ORB_nfeatures,m_ORB_scaleFactor,m_ORB_nlevels,m_ORB_edgeThreshold,m_ORB_firstLevel);
	detector = cv::ORB::create(m_ORB_nfeatures, m_ORB_scaleFactor, m_ORB_nlevels, m_ORB_edgeThreshold, m_ORB_firstLevel);
	...
	if (m_ObjName == "None") {
		std::cout << "Model is None, so model image was not loaded"
			<< std::endl;
		m_AcceptModelService.unlockSetModel();
		//std::cout << "_setModelFlag変更"<< std::endl;
		_readModelFlag = true;
		return RTC::RTC_OK;
	}
...
RTC::ReturnCode_t ObjectSensor_ORB::onDeactivated(RTC::UniqueId ec_id)
{
	//ここから
	_iv.closeWindow();
	m_AcceptModelService.lockSetModel();
...
RTC::ReturnCode_t ObjectSensor_ORB::onExecute(RTC::UniqueId ec_id)
{
	//ここから
...
/*
RTC::ReturnCode_t ObjectSensor_ORB::onAborting(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
RTC::ReturnCode_t ObjectSensor_ORB::onError(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}

/*
RTC::ReturnCode_t ObjectSensor_ORB::onReset(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ObjectSensor_ORB::onStateUpdate(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ObjectSensor_ORB::onRateChanged(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/

bool ObjectSensor_ORB::findObject() {
	...
	if (m_SingleImageIn.isNew()) {
		...
		if (m_Display == "on") {
			...
			cv::namedWindow("Result_Image_ORB", CV_WINDOW_AUTOSIZE);
			cv::imshow("Result_Image_ORB", imgRes);
			cv::waitKey(1);

		}
		else if (m_Display == "off") {
			//_iv.closeWindow();
			cv::destroyWindow("Result_Image_ORB");
		}
...
// when "m_AcceptModelService->setModel()" is called by other components,
// this function is executed.
void ObjectSensor_ORB::invokeEvent(const std::string &ev) {
...
extern "C"
{
  ...
  void ObjectSensor_ORBInit(RTC::Manager* manager)
  {
    coil::Properties profile(objectsensor_orb_spec);
    manager->registerFactory(profile,
                             RTC::Create<ObjectSensor_ORB>,
                             RTC::Delete<ObjectSensor_ORB>);
  }
