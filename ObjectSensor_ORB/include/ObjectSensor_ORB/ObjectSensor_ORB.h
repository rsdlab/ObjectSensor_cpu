...
#ifndef OBJECTSENSOR_ORB_H
#define OBJECTSENSOR_ORB_H
	...
	public EventListener<std::string>
{
 public:
   ...
   */
  ObjectSensor_ORB(RTC::Manager* manager);
 ...
 protected:
   ...
   * - DefaultValue: 31
   */
  int m_ORB_edgeThreshold;
  /*!
   * 
   * - Name:  ORB_firstLevel
   * - DefaultValue: 0
   */
  int m_ORB_firstLevel;
  ...
  /*!
   */
  AcceptModelServiceSVC_impl m_AcceptModelService;
...
extern "C"
{
  DLL_EXPORT void ObjectSensor_ORBInit(RTC::Manager* manager);
};

#endif // OBJECTSENSOR_ORB_H
