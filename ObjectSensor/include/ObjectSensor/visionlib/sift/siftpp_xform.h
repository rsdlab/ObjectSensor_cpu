...
*/
typedef bool (*ransac_xform_fn)( sPoint2D64f* pts, sPoint2D64f* mpts, int n, double homography[9] );
...
*/
typedef double (*ransac_err_fn)( sPoint2D64f pt, sPoint2D64f mpt, double homography[9] );
...
*/
extern bool ransac_xform( sift_feature* features, int n, int mtype,
			  ransac_xform_fn xform_fn, int m,
			  double p_badxform, ransac_err_fn err_fn,
			  double err_tol, sift_feature*** inliers,
			  int* n_in, double homography[9] );
...
*/
extern bool lsq_homography(sPoint2D64f* pts, sPoint2D64f* mpts, int n, double homography[9]);
...
*/
extern double homog_xfer_err( sPoint2D64f pt, sPoint2D64f mpt, double homography[9] );
