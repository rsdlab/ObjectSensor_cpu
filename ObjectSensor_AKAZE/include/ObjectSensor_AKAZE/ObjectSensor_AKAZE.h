...
#ifndef OBJECTSENSOR_AKAZE_H
#define OBJECTSENSOR_AKAZE_H
  ...
  public EventListener<std::string>
{
 public:
   ...
   */
  ObjectSensor_AKAZE(RTC::Manager* manager);
 ...
 protected:
   ...
   * - Name:  AKAZE_nOctavelaters
   * - DefaultValue: 4
   */
  int m_AKAZE_nOctavelaters;
  /*!
   * カメラ画像に対するAKAZE特徴量の設定項目
   * - Name:  AKAZE_nOctaves
   * - DefaultValue: 4
   */
  int m_AKAZE_nOctaves;
  /*!
  ...
  /*!
   * 
   * - Name:  AKAZE_threshold
   * - DefaultValue: 0.0005f
   */
  float m_AKAZE_threshold;
...
extern "C"
{
  DLL_EXPORT void ObjectSensor_AKAZEInit(RTC::Manager* manager);
};

#endif // OBJECTSENSOR_AKAZE_H
