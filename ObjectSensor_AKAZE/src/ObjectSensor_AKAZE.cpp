...
static const char* objectsensor_akaze_spec[] =
  {
    "implementation_id", "ObjectSensor_AKAZE",
    "type_name",         "ObjectSensor_AKAZE",
    ...
    "conf.default.AKAZE_nOctavelaters", "4",
    "conf.default.AKAZE_nOctaves", "4",
    "conf.default.Display", "on",
    "conf.default.ObjName", "None",
    "conf.default.AKAZE_threshold", "0.0005f",
    // Widget
    "conf.__widget__.CfgName", "text",
    "conf.__widget__.AKAZE_nOctavelaters", "text",
    "conf.__widget__.AKAZE_nOctaves", "text",
    "conf.__widget__.Display", "text",
    "conf.__widget__.ObjName", "text",
    "conf.__widget__.AKAZE_threshold", "text",
    // Constraints
    ""
  };
// </rtc-template>
 ...
 */
ObjectSensor_AKAZE::ObjectSensor_AKAZE(RTC::Manager* manager)
 ...
 * @brief destructor
 */
ObjectSensor_AKAZE::~ObjectSensor_AKAZE()
{
	// ここから
...
RTC::ReturnCode_t ObjectSensor_AKAZE::onInitialize()
{
  // Registration: InPort/OutPort/Service
  // <rtc-template block="registration">
  // Set InPort buffers
  ...
  bindParameter("AKAZE_nOctavelaters", m_AKAZE_nOctavelaters, "4");
  bindParameter("AKAZE_nOctaves", m_AKAZE_nOctaves, "4");
  bindParameter("Display", m_Display, "on");
  bindParameter("ObjName", m_ObjName, "None");
  bindParameter("AKAZE_threshold", m_AKAZE_threshold, "0.0005f");
  // </rtc-template>
  //ここから
  ...
  std::cout << "setting initial AKAZE parameter" << std::endl;
  // set parameter
  _sift.use_gpu = true;
...
RTC::ReturnCode_t ObjectSensor_AKAZE::onFinalize()
{
  return RTC::RTC_OK;
}

/*
RTC::ReturnCode_t ObjectSensor_AKAZE::onStartup(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ObjectSensor_AKAZE::onShutdown(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
RTC::ReturnCode_t ObjectSensor_AKAZE::onActivated(RTC::UniqueId ec_id)
{
	//ここから
	...
	extractor = cv::AKAZE::create(cv::AKAZE::DESCRIPTOR_MLDB, 0, 3, m_AKAZE_threshold, m_AKAZE_nOctaves, m_AKAZE_nOctavelaters, cv::KAZE::DIFF_PM_G2);
	detector = cv::AKAZE::create(cv::AKAZE::DESCRIPTOR_MLDB, 0, 3, m_AKAZE_threshold, m_AKAZE_nOctaves, m_AKAZE_nOctavelaters, cv::KAZE::DIFF_PM_G2);
...
RTC::ReturnCode_t ObjectSensor_AKAZE::onDeactivated(RTC::UniqueId ec_id)
{
	//ここから
	_iv.closeWindow();
	m_ModelAcceptor.lockSetModel();
...
RTC::ReturnCode_t ObjectSensor_AKAZE::onExecute(RTC::UniqueId ec_id)
{
	//ここから
...
/*
RTC::ReturnCode_t ObjectSensor_AKAZE::onAborting(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
RTC::ReturnCode_t ObjectSensor_AKAZE::onError(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}

/*
RTC::ReturnCode_t ObjectSensor_AKAZE::onReset(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ObjectSensor_AKAZE::onStateUpdate(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ObjectSensor_AKAZE::onRateChanged(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/

bool ObjectSensor_AKAZE::findObject() {
	...
	if (m_SingleImageIn.isNew()) {
		...
		if (m_Display == "on") {
			...
			cv::namedWindow("Result_Image_AKAZE", CV_WINDOW_AUTOSIZE);
			cv::imshow("Result_Image_AKAZE", imgRes);
			cv::waitKey(1);

		}
		else if (m_Display == "off") {
			//_iv.closeWindow();
			cv::destroyWindow("Result_Image_AKAZE");
		}
...
void ObjectSensor_AKAZE::invokeEvent(const std::string &ev) {
...
extern "C"
{
  ...
  void ObjectSensor_AKAZEInit(RTC::Manager* manager)
  {
    coil::Properties profile(objectsensor_akaze_spec);
    manager->registerFactory(profile,
                             RTC::Create<ObjectSensor_AKAZE>,
                             RTC::Delete<ObjectSensor_AKAZE>);
  }
